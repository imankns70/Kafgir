...
export function CartPage({ items, onQuantityChange, onBack, onSuccess }: Props) {
  return <main className="checkout-page">
    <div className="page-actions"><div><span className="eyebrow"><Icon name="confirm" size="sm" /> مرحله نهایی</span><h1 className="section-title">ثبت سفارش</h1></div><button className="outline-button" onClick={onBack}><Icon name="back" size="md" />بازگشت به منو</button></div>
